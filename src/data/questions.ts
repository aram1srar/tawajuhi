...
export const questions: Record<string, Question[]> = {
  cs: [
    // Original theory (8)
    { id: "cs1", type: "theory", path: "cs", question: { ar: "أي من المكونات التالية يعتبر \"عقل\" الحاسب؟", en: "Which of the following is considered the \"brain\" of the computer?" }, options: [{ ar: "الرام (ذاكرة الوصول العشوائي)", en: "RAM (Random Access Memory)" }, { ar: "المعالج (CPU)", en: "Processor (CPU)" }, { ar: "القرص الصلب (HDD/SSD)", en: "Hard Drive (HDD/SSD)" }, { ar: "اللوحة الأم", en: "Motherboard" }], correctIndex: 1, explanation: { ar: "المعالج (CPU) هو العنصر المسؤول عن تنفيذ العمليات الحسابية والمنطقية", en: "The CPU executes all computational and logical operations" } },
    { id: "cs2", type: "theory", path: "cs", question: { ar: "لغة البرمجة التي تُستخدم بكثرة في مجال الذكاء الاصطناعي هي:", en: "The programming language widely used in AI is:" }, options: [{ ar: "Python", en: "Python" }, { ar: "Java", en: "Java" }, { ar: "C++", en: "C++" }, { ar: "JavaScript", en: "JavaScript" }], correctIndex: 0, explanation: { ar: "Python هي اللغة الأكثر استخداماً في مجال الذكاء الاصطناعي", en: "Python is the most widely used language in AI" } },
    { id: "cs3", type: "theory", path: "cs", question: { ar: "أصغر وحدة لتخزين البيانات في الحاسب هي:", en: "The smallest unit of data storage in a computer is:" }, options: [{ ar: "بايت (Byte)", en: "Byte" }, { ar: "بت (Bit)", en: "Bit" }, { ar: "كيلوبايت (KB)", en: "Kilobyte (KB)" }, { ar: "نيبل (Nibble)", en: "Nibble" }], correctIndex: 1, explanation: { ar: "البت (Bit) هو أصغر وحدة لتخزين البيانات", en: "A Bit is the smallest data unit" } },
    { id: "cs4", type: "theory", path: "cs", question: { ar: "الرمز الذي يمثل \"البوابة المنطقية\" التي تعطي مخرجاً صحيحاً فقط إذا كان جميع المدخلات صحيحة:", en: "The logic gate that outputs true only when ALL inputs are true:" }, options: [{ ar: "OR", en: "OR" }, { ar: "AND", en: "AND" }, { ar: "XOR", en: "XOR" }, { ar: "NAND", en: "NAND" }], correctIndex: 1, explanation: { ar: "بوابة AND تعطي مخرجاً صحيحاً فقط عندما تكون جميع المدخلات صحيحة", en: "AND gate outputs true only when all inputs are true" } },
    { id: "cs5", type: "theory", path: "cs", question: { ar: "نظام الترقيم الذي يعتمد عليه الحاسب في معالجة البيانات هو:", en: "The numbering system computers use to process data is:" }, options: [{ ar: "العشري (Decimal)", en: "Decimal" }, { ar: "الثنائي (Binary)", en: "Binary" }, { ar: "الثماني (Octal)", en: "Octal" }, { ar: "الستة عشري (Hexadecimal)", en: "Hexadecimal" }], correctIndex: 1, explanation: { ar: "النظام الثنائي (0 و 1) هو أساس عمل الحاسب", en: "Binary is the foundation of computer processing" } },
    { id: "cs6", type: "theory", path: "cs", question: { ar: "\"البرمجيات الخبيثة\" التي تشفر ملفات المستخدم وتطلب مقابلاً مادياً هي:", en: "Malware that encrypts user files and demands payment is:" }, options: [{ ar: "الفيروسات (Virus)", en: "Viruses" }, { ar: "فدية (Ransomware)", en: "Ransomware" }, { ar: "حصان طروادة (Trojan)", en: "Trojan Horse" }, { ar: "برامج التجسس (Spyware)", en: "Spyware" }], correctIndex: 1, explanation: { ar: "برامج الفدية تشفر الملفات وتطلب مبلغاً مالياً", en: "Ransomware encrypts files and demands payment" } },
    { id: "cs7", type: "theory", path: "cs", question: { ar: "ما هو البروتوكول المسؤول عن نقل صفحات الويب بأمان؟", en: "Which protocol is responsible for secure web page transfer?" }, options: [{ ar: "FTP", en: "FTP" }, { ar: "HTTP", en: "HTTP" }, { ar: "HTTPS", en: "HTTPS" }, { ar: "SSH", en: "SSH" }], correctIndex: 2, explanation: { ar: "HTTPS يضيف طبقة تشفير SSL/TLS", en: "HTTPS adds SSL/TLS encryption" } },
    { id: "cs8", type: "theory", path: "cs", question: { ar: "تقنية تسمح للأجهزة بالتواصل مع بعضها عبر الإنترنت دون تدخل بشري:", en: "Technology that allows devices to communicate over the internet without human intervention:" }, options: [{ ar: "الواقع الافتراضي (VR)", en: "Virtual Reality" }, { ar: "إنترنت الأشياء (IoT)", en: "Internet of Things (IoT)" }, { ar: "الحوسبة السحابية", en: "Cloud Computing" }, { ar: "تقنية البلوك تشين", en: "Blockchain Technology" }], correctIndex: 1, explanation: { ar: "إنترنت الأشياء (IoT) يربط الأجهزة ببعضها", en: "IoT connects devices to each other" } },
    // Original interest (6) - upgraded to 4 options
    { id: "cs9", type: "interest", path: "cs", question: { ar: "هل تفضل قضاء وقت فراغك في تعلم كيفية عمل تطبيق معين؟", en: "Do you prefer spending free time learning how a specific app works?" }, options: [{ ar: "نعم، أبحث في التفاصيل التقنية", en: "Yes, I dig into technical details" }, { ar: "أحياناً إذا كان التطبيق مثيراً", en: "Sometimes if the app is interesting" }, { ar: "أفضل استخدام التطبيقات فقط", en: "I prefer just using apps" }, { ar: "لا يهمني كيف تعمل", en: "I don't care how they work" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "cs10", type: "interest", path: "cs", question: { ar: "هل تستمتع بفك الأجهزة الإلكترونية القديمة لاستكشاف قطعها؟", en: "Do you enjoy taking apart old electronics to explore their components?" }, options: [{ ar: "نعم، دائماً أفعل ذلك", en: "Yes, I always do that" }, { ar: "أحاول أحياناً لكن بحذر", en: "I try sometimes but carefully" }, { ar: "أفضل مشاهدة فيديوهات عن ذلك", en: "I prefer watching videos about it" }, { ar: "لا يستهويني ذلك أبداً", en: "That doesn't interest me at all" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "cs11", type: "interest", path: "cs", question: { ar: "هل تفضل حل المسائل الرياضية والمنطقية على كتابة المقالات الأدبية؟", en: "Do you prefer solving math and logic problems over writing essays?" }, options: [{ ar: "نعم، المسائل المنطقية أكثر متعة", en: "Yes, logic problems are more fun" }, { ar: "أستمتع بالاثنين بشكل متساوٍ", en: "I enjoy both equally" }, { ar: "أميل للكتابة الأدبية أكثر", en: "I lean more toward writing" }, { ar: "لا أحب أياً منهما", en: "I don't enjoy either" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "cs12", type: "interest", path: "cs", question: { ar: "هل يستهويك تصميم نماذج ثلاثية الأبعاد أو واجهات رقمية باستخدام الكمبيوتر؟", en: "Are you interested in designing 3D models or digital interfaces using a computer?" }, options: [{ ar: "نعم، أجد فيه إبداعاً تقنياً", en: "Yes, I find technical creativity in it" }, { ar: "أحب التصميم لكن بأدوات بسيطة", en: "I like design but with simple tools" }, { ar: "أفضل الجانب البرمجي فقط", en: "I prefer only the programming side" }, { ar: "لا يستهويني التصميم", en: "Design doesn't interest me" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "cs13", type: "interest", path: "cs", question: { ar: "هل تشعر بالإثارة عند اكتشاف ثغرة تقنية أو حل مشكلة في جهاز؟", en: "Do you feel excited when discovering a tech bug or fixing a device problem?" }, options: [{ ar: "نعم، أشعر بالإنجاز", en: "Yes, I feel accomplished" }, { ar: "أحياناً لكن أفضل أن يحلها غيري", en: "Sometimes but I'd rather someone else fix it" }, { ar: "أتعامل معها كمهمة عادية", en: "I treat it as a regular task" }, { ar: "أتجنب المشاكل التقنية", en: "I avoid technical problems" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "cs14", type: "interest", path: "cs", question: { ar: "هل تفضل العمل المنفرد على مشاريع تتطلب تركيزاً تقنياً عالياً؟", en: "Do you prefer working alone on projects requiring high technical focus?" }, options: [{ ar: "نعم، أنتج أفضل بمفردي", en: "Yes, I produce better alone" }, { ar: "أحب العمل الفردي مع استشارة الفريق", en: "I like working alone with team consultation" }, { ar: "أفضل العمل الجماعي دائماً", en: "I always prefer teamwork" }, { ar: "حسب طبيعة المشروع", en: "Depends on the project nature" }], correctIndex: 0, explanation: { ar: "", en: "" } },
  ...
  health: [
    // Original theory (8)
    { id: "h1", type: "theory", path: "health", question: { ar: "أي جزء من الخلية يحتوي على المعلومات الوراثية (DNA)؟", en: "Which part of the cell contains genetic information (DNA)?" }, options: [{ ar: "السيتوبلازم", en: "Cytoplasm" }, { ar: "النواة", en: "Nucleus" }, { ar: "الميتوكوندريا", en: "Mitochondria" }, { ar: "الريبوسومات", en: "Ribosomes" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "h2", type: "theory", path: "health", question: { ar: "العملية التي يقوم بها النبات لصنع غذائه باستخدام الضوء هي:", en: "The process plants use to make food using light is:" }, options: [{ ar: "التنفس الخلوي", en: "Cellular Respiration" }, { ar: "البناء الضوئي", en: "Photosynthesis" }, { ar: "التخمر", en: "Fermentation" }, { ar: "الانتشار", en: "Diffusion" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "h3", type: "theory", path: "health", question: { ar: "فصيلة الدم التي تسمى \"المعطي العام\" هي:", en: "The blood type called the \"universal donor\" is:" }, options: [{ ar: "AB+", en: "AB+" }, { ar: "A-", en: "A-" }, { ar: "O-", en: "O-" }, { ar: "B+", en: "B+" }], correctIndex: 2, explanation: { ar: "", en: "" } },
    { id: "h4", type: "theory", path: "health", question: { ar: "المادة الكيميائية التي تسرع التفاعلات الحيوية في الجسم دون أن تُستهلك هي:", en: "The chemical that speeds up biological reactions without being consumed is:" }, options: [{ ar: "الهرمون", en: "Hormone" }, { ar: "الإنزيم", en: "Enzyme" }, { ar: "الفيتامين", en: "Vitamin" }, { ar: "البروتين البنائي", en: "Structural Protein" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "h5", type: "theory", path: "health", question: { ar: "الغاز الذي يحتاجه الإنسان في عملية التنفس الخلوي هو:", en: "The gas humans need for cellular respiration is:" }, options: [{ ar: "ثاني أكسيد الكربون", en: "Carbon Dioxide" }, { ar: "الأكسجين", en: "Oxygen" }, { ar: "النيتروجين", en: "Nitrogen" }, { ar: "أول أكسيد الكربون", en: "Carbon Monoxide" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "h6", type: "theory", path: "health", question: { ar: "مرض \"السكري من النوع الأول\" ينتج عن خلل في إفراز هرمون:", en: "Type 1 diabetes results from a disorder in the secretion of:" }, options: [{ ar: "الأدرينالين", en: "Adrenaline" }, { ar: "الجلوكاجون", en: "Glucagon" }, { ar: "الإنسولين", en: "Insulin" }, { ar: "الكورتيزول", en: "Cortisol" }], correctIndex: 2, explanation: { ar: "", en: "" } },
    { id: "h7", type: "theory", path: "health", question: { ar: "الوحدة الأساسية لبناء الكائن الحي هي:", en: "The basic building unit of living organisms is:" }, options: [{ ar: "النسيج", en: "Tissue" }, { ar: "الخلية", en: "Cell" }, { ar: "العضو", en: "Organ" }, { ar: "الجزيء", en: "Molecule" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "h8", type: "theory", path: "health", question: { ar: "علم دراسة التفاعلات بين الكائنات الحية وبيئتها هو:", en: "The science of studying interactions between organisms and their environment is:" }, options: [{ ar: "علم البيئة (الإيكولوجيا)", en: "Ecology" }, { ar: "علم وظائف الأعضاء", en: "Physiology" }, { ar: "علم التشريح", en: "Anatomy" }, { ar: "علم الأحياء الدقيقة", en: "Microbiology" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    // Original interest (6) - upgraded to 4 options
    { id: "h9", type: "interest", path: "health", question: { ar: "هل تشعر بالرغبة في مساعدة الناس عند تعرضهم لوعكة صحية؟", en: "Do you feel the urge to help people when they're feeling unwell?" }, options: [{ ar: "نعم، أبادر فوراً", en: "Yes, I step in immediately" }, { ar: "أحاول المساعدة إذا استطعت", en: "I try to help if I can" }, { ar: "أتعاطف لكن لا أتدخل عادة", en: "I sympathize but don't usually intervene" }, { ar: "لا أشعر بذلك", en: "I don't feel that urge" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "h10", type: "interest", path: "health", question: { ar: "هل تستمتع بمشاهدة البرامج الوثائقية عن جسم الإنسان أو الكائنات الحية؟", en: "Do you enjoy watching documentaries about the human body or organisms?" }, options: [{ ar: "نعم، أبحث عنها دائماً", en: "Yes, I always seek them out" }, { ar: "أشاهدها أحياناً", en: "I watch them sometimes" }, { ar: "فقط إذا كانت مطلوبة للدراسة", en: "Only if required for study" }, { ar: "لا تستهويني", en: "They don't interest me" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "h11", type: "interest", path: "health", question: { ar: "هل لديك صبر لإجراء تجارب في المختبر ومراقبة النتائج لفترات طويلة؟", en: "Do you have patience for lab experiments and observing results over long periods?" }, options: [{ ar: "نعم، أستمتع بالعملية كاملة", en: "Yes, I enjoy the whole process" }, { ar: "أحب التجارب لكن أفضلها السريعة", en: "I like experiments but prefer quick ones" }, { ar: "أفضل القراءة النظرية عن التجارب", en: "I prefer reading theory over experiments" }, { ar: "لا أحب العمل المخبري", en: "I don't like lab work" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "h12", type: "interest", path: "health", question: { ar: "هل تهتم بقراءة النشرات الدوائية ومعرفة آثارها الجانبية وتفاعلاتها؟", en: "Do you care about reading drug leaflets and learning about side effects and interactions?" }, options: [{ ar: "نعم، أقرأها بالتفصيل", en: "Yes, I read them in detail" }, { ar: "ألقي نظرة سريعة", en: "I take a quick glance" }, { ar: "فقط عندما أحتاج دواءً معيناً", en: "Only when I need a specific medication" }, { ar: "لا أهتم بها", en: "I don't care about them" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "h13", type: "interest", path: "health", question: { ar: "هل تفضل العمل في بيئة المستشفيات والمراكز الصحية رغم ضغوطاتها؟", en: "Do you prefer working in hospitals despite the pressures?" }, options: [{ ar: "نعم، الضغط يحفزني", en: "Yes, pressure motivates me" }, { ar: "نعم لكن أفضل ساعات منتظمة", en: "Yes but I prefer regular hours" }, { ar: "أفضل بيئة عمل أهدأ", en: "I prefer a calmer work environment" }, { ar: "لا أحب بيئة المستشفيات", en: "I don't like hospital environments" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "h14", type: "interest", path: "health", question: { ar: "هل يستهويك البحث عن حلول علمية لمشاكل التلوث البيئي والأمراض المرتبطة به؟", en: "Are you interested in finding scientific solutions for environmental pollution and related diseases?" }, options: [{ ar: "نعم، أجد الموضوع مهماً جداً", en: "Yes, I find it very important" }, { ar: "أهتم لكن ليس كتخصص أساسي", en: "I care but not as a primary focus" }, { ar: "أحياناً أتابع الأخبار عنه", en: "Sometimes I follow news about it" }, { ar: "لا يستهويني", en: "It doesn't interest me" }], correctIndex: 0, explanation: { ar: "", en: "" } },
  ...
  business: [
    // Original theory (8)
    { id: "b1", type: "theory", path: "business", question: { ar: "\"العرض والطلب\" هما الركيزتان الأساسيتان لعلم:", en: "\"Supply and demand\" are the two main pillars of:" }, options: [{ ar: "الإدارة العامة", en: "Public Administration" }, { ar: "الاقتصاد", en: "Economics" }, { ar: "المحاسبة المالية", en: "Financial Accounting" }, { ar: "إدارة الموارد البشرية", en: "Human Resources" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "b2", type: "theory", path: "business", question: { ar: "القائمة التي توضح أرباح وخسائر الشركة خلال فترة معينة هي:", en: "The statement showing a company's profits and losses over a period is:" }, options: [{ ar: "الميزانية العمومية", en: "Balance Sheet" }, { ar: "قائمة الدخل", en: "Income Statement" }, { ar: "قائمة التدفقات النقدية", en: "Cash Flow Statement" }, { ar: "قائمة التغيرات في حقوق الملكية", en: "Statement of Changes in Equity" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "b3", type: "theory", path: "business", question: { ar: "عملية ترويج المنتجات للوصول إلى العميل المستهدف تسمى:", en: "The process of promoting products to reach target customers is called:" }, options: [{ ar: "التوزيع اللوجستي", en: "Logistics Distribution" }, { ar: "التسويق", en: "Marketing" }, { ar: "إدارة سلسلة التوريد", en: "Supply Chain Management" }, { ar: "العلاقات العامة", en: "Public Relations" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "b4", type: "theory", path: "business", question: { ar: "\"رأس المال\" في المشاريع يشمل:", en: "\"Capital\" in business includes:" }, options: [{ ar: "الأموال السائلة فقط", en: "Cash only" }, { ar: "الأموال والمعدات والأصول", en: "Money, equipment and assets" }, { ar: "الموظفين والخبرات فقط", en: "Employees and expertise only" }, { ar: "الأرباح المحتجزة فقط", en: "Retained earnings only" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "b5", type: "theory", path: "business", question: { ar: "عندما ترتفع الأسعار بشكل مستمر، تسمى هذه الظاهرة:", en: "When prices rise continuously, this phenomenon is called:" }, options: [{ ar: "الركود الاقتصادي", en: "Economic Recession" }, { ar: "التضخم", en: "Inflation" }, { ar: "الانكماش", en: "Deflation" }, { ar: "التضخم المصحوب بالركود", en: "Stagflation" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "b6", type: "theory", path: "business", question: { ar: "الشخص الذي يتحمل المخاطرة لبدء مشروع جديد وتحويل الفكرة إلى واقع يسمى:", en: "A person who takes risks to start a new business and turn ideas into reality is called:" }, options: [{ ar: "مدير تنفيذي", en: "CEO" }, { ar: "رائد أعمال", en: "Entrepreneur" }, { ar: "مستثمر ملائكي", en: "Angel Investor" }, { ar: "مستشار مالي", en: "Financial Consultant" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "b7", type: "theory", path: "business", question: { ar: "أي مما يلي يعتبر من الأصول (Assets) للشركة؟", en: "Which of the following is considered a company asset?" }, options: [{ ar: "القروض والالتزامات", en: "Loans and liabilities" }, { ar: "المباني والأراضي والمعدات", en: "Buildings, land and equipment" }, { ar: "رواتب الموظفين", en: "Employee salaries" }, { ar: "فواتير الموردين", en: "Supplier invoices" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "b8", type: "theory", path: "business", question: { ar: "وظيفة \"التخطيط\" في الإدارة تهدف إلى:", en: "The \"planning\" function in management aims to:" }, options: [{ ar: "تحديد الأهداف المستقبلية ووضع استراتيجيات تحقيقها", en: "Set future goals and strategies to achieve them" }, { ar: "مراقبة أداء الموظفين فقط", en: "Monitor employee performance only" }, { ar: "تنظيم الهيكل الإداري", en: "Organize administrative structure" }, { ar: "حل النزاعات بين الأقسام", en: "Resolve interdepartmental conflicts" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    // Original interest (6) - upgraded to 4 options
    { id: "b9", type: "interest", path: "business", question: { ar: "هل تحب تنظيم الفعاليات وإدارة الميزانيات المخصصة لها؟", en: "Do you enjoy organizing events and managing their budgets?" }, options: [{ ar: "نعم، أجد فيه تحدياً ممتعاً", en: "Yes, I find it an enjoyable challenge" }, { ar: "أحياناً إذا كان الحدث يهمني", en: "Sometimes if the event matters to me" }, { ar: "أفضل المشاركة لا التنظيم", en: "I prefer participating, not organizing" }, { ar: "لا أحب ذلك", en: "I don't like that" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "b10", type: "interest", path: "business", question: { ar: "هل تجد نفسك بارعاً في إقناع زملائك بفكرة أو مقترح معين؟", en: "Do you find yourself skilled at convincing peers of an idea?" }, options: [{ ar: "نعم، أستطيع الإقناع بسهولة", en: "Yes, I can persuade easily" }, { ar: "أحاول لكن لست دائماً ناجحاً", en: "I try but I'm not always successful" }, { ar: "أفضل أن يقتنعوا بأنفسهم", en: "I prefer they convince themselves" }, { ar: "لا أحب محاولة إقناع الآخرين", en: "I don't like trying to convince others" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "b11", type: "interest", path: "business", question: { ar: "هل تهتم بمتابعة أخبار الشركات العالمية وأسعار العملات والأسواق؟", en: "Are you interested in following global company news, currencies and markets?" }, options: [{ ar: "نعم، أتابعها باستمرار", en: "Yes, I follow them constantly" }, { ar: "أتابع الأخبار الكبيرة فقط", en: "I follow only major news" }, { ar: "أتابعها إذا أثرت علي شخصياً", en: "I follow if it affects me personally" }, { ar: "لا تهمني أخبار الأعمال", en: "Business news doesn't interest me" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "b12", type: "interest", path: "business", question: { ar: "هل تفضل العمل المكتبي القيادي على العمل الميداني أو التنفيذي؟", en: "Do you prefer office leadership work over fieldwork?" }, options: [{ ar: "نعم، القيادة من المكتب تناسبني", en: "Yes, leading from the office suits me" }, { ar: "أحب المزج بين الاثنين", en: "I like mixing both" }, { ar: "أفضل العمل الميداني", en: "I prefer fieldwork" }, { ar: "لا أعرف بعد", en: "I don't know yet" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "b13", type: "interest", path: "business", question: { ar: "هل تستمتع بحساب الأرقام والنسب المئوية وتحليل البيانات المالية؟", en: "Do you enjoy calculating numbers, percentages, and analyzing financial data?" }, options: [{ ar: "نعم، الأرقام لغتي", en: "Yes, numbers are my language" }, { ar: "أستمتع بها في سياق عملي", en: "I enjoy them in practical contexts" }, { ar: "أتعامل معها عند الحاجة فقط", en: "I deal with them only when needed" }, { ar: "لا أحب التعامل مع الأرقام", en: "I don't like dealing with numbers" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "b14", type: "interest", path: "business", question: { ar: "هل تحب العمل في بيئة تتطلب التفاوض واتخاذ القرارات المالية؟", en: "Do you like working in environments requiring negotiation and financial decisions?" }, options: [{ ar: "نعم، التفاوض يحمسني", en: "Yes, negotiation excites me" }, { ar: "أحب التفاوض لكن ليس دائماً", en: "I like negotiation but not always" }, { ar: "أفضل بيئة عمل هادئة", en: "I prefer a calm work environment" }, { ar: "التفاوض يسبب لي ضغطاً", en: "Negotiation stresses me" }], correctIndex: 0, explanation: { ar: "", en: "" } },
  ...
  shariah: [
    // Original theory (8)
    { id: "sh1", type: "theory", path: "shariah", question: { ar: "القواعد الفقهية: أي منها تعني أن الأصل في الأشياء الطهارة حتى يثبت العكس؟", en: "Which legal maxim means things are presumed pure until proven otherwise?" }, options: [{ ar: "اليقين لا يزول بالشك", en: "Certainty is not overruled by doubt" }, { ar: "المشقة تجلب التيسير", en: "Hardship brings ease" }, { ar: "الضرر يزال", en: "Harm must be eliminated" }, { ar: "العادة محكّمة", en: "Custom is authoritative" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "sh2", type: "theory", path: "shariah", question: { ar: "ما هو السند في علم الحديث؟", en: "What is the 'Sanad' in Hadith science?" }, options: [{ ar: "متن الحديث (النص)", en: "Text of the Hadith (Matn)" }, { ar: "سلسلة الرواة الموصلة للمتن", en: "Chain of narrators leading to the text" }, { ar: "شرح وتفسير الحديث", en: "Explanation and interpretation of the Hadith" }, { ar: "درجة صحة الحديث", en: "Authentication level of the Hadith" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "sh3", type: "theory", path: "shariah", question: { ar: "أي من التالي يعتبر من المصادر \"التبعية\" للتشريع الإسلامي؟", en: "Which is a 'secondary' source of Islamic legislation?" }, options: [{ ar: "القرآن الكريم", en: "The Holy Quran" }, { ar: "السنة النبوية", en: "Prophetic Sunnah" }, { ar: "القياس", en: "Analogy (Qiyas)" }, { ar: "الإجماع", en: "Consensus (Ijma')" }], correctIndex: 2, explanation: { ar: "", en: "" } },
    { id: "sh4", type: "theory", path: "shariah", question: { ar: "نظام الحكم في المملكة العربية السعودية يستمد سلطته من:", en: "Saudi Arabia's governance derives its authority from:" }, options: [{ ar: "الأنظمة الدولية والمعاهدات", en: "International systems and treaties" }, { ar: "كتاب الله وسنة رسوله", en: "The Book of Allah and Sunnah" }, { ar: "الأعراف والتقاليد القبلية", en: "Tribal customs and traditions" }, { ar: "الدستور المكتوب", en: "Written constitution" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "sh5", type: "theory", path: "shariah", question: { ar: "ما هو الفرق بين \"القضاء\" و \"الفتوى\"؟", en: "What is the difference between 'judiciary' and 'fatwa'?" }, options: [{ ar: "القضاء ملزم والفتوى غير ملزمة", en: "Judiciary is binding, fatwa is not" }, { ar: "الفتوى ملزمة والقضاء اختياري", en: "Fatwa is binding, judiciary is optional" }, { ar: "كلاهما ملزم بنفس الدرجة", en: "Both are equally binding" }, { ar: "كلاهما غير ملزم ويعتمد على القبول", en: "Neither is binding, depends on acceptance" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "sh6", type: "theory", path: "shariah", question: { ar: "الورثة الذين لهم نصيب مقدر في الشرع يسمون:", en: "Heirs with a fixed share in Shari'ah are called:" }, options: [{ ar: "العصبة", en: "Agnates ('Asabah)" }, { ar: "أصحاب الفروض", en: "Fixed-share heirs (Ashab al-Furud)" }, { ar: "ذوي الأرحام", en: "Relatives (Dhawi al-Arham)" }, { ar: "الموصى لهم", en: "Legatees (al-Musa lahum)" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "sh7", type: "theory", path: "shariah", question: { ar: "\"التعزير\" في الشريعة الإسلامية هو عقوبة:", en: "'Ta'zir' in Islamic Shari'ah is a punishment that is:" }, options: [{ ar: "مقدرة ومحددة شرعاً (حد)", en: "Fixed and defined by Shari'ah (Hadd)" }, { ar: "يترك تقديرها للقاضي حسب الجريمة", en: "Left to the judge's discretion based on the crime" }, { ar: "مالية فقط (غرامة)", en: "Financial only (fine)" }, { ar: "بدنية فقط", en: "Physical only" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    { id: "sh8", type: "theory", path: "shariah", question: { ar: "الجهة المسؤولة عن توثيق العقود والوكالات في المملكة هي:", en: "The authority for documenting contracts in Saudi Arabia is:" }, options: [{ ar: "وزارة العدل", en: "Ministry of Justice" }, { ar: "كتابة العدل", en: "Notary Public" }, { ar: "المحكمة العامة", en: "General Court" }, { ar: "هيئة حقوق الإنسان", en: "Human Rights Commission" }], correctIndex: 1, explanation: { ar: "", en: "" } },
    // Original interest (6) - upgraded to 4 options
    { id: "sh9", type: "interest", path: "shariah", question: { ar: "هل تستمتع بقراءة الكتب التاريخية والبحث في أصول القوانين والتشريعات؟", en: "Do you enjoy reading historical books and researching the origins of laws?" }, options: [{ ar: "نعم، أجد فيها عمقاً فكرياً", en: "Yes, I find intellectual depth in them" }, { ar: "أقرأها أحياناً للاطلاع", en: "I read them sometimes for knowledge" }, { ar: "أفضل القراءات الحديثة والمعاصرة", en: "I prefer modern contemporary readings" }, { ar: "لا تستهويني القراءة التاريخية", en: "Historical reading doesn't interest me" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "sh10", type: "interest", path: "shariah", question: { ar: "هل تجد لديك القدرة على التحدث أمام الجمهور وإقناعهم بالحجج والبراهين؟", en: "Can you speak publicly and convince with arguments and evidence?" }, options: [{ ar: "نعم، أستمتع بالخطابة والإقناع", en: "Yes, I enjoy public speaking and persuasion" }, { ar: "أستطيع لكن أحتاج تحضيراً", en: "I can but need preparation" }, { ar: "أفضل الكتابة على الخطابة", en: "I prefer writing over public speaking" }, { ar: "أتجنب التحدث أمام الجمهور", en: "I avoid public speaking" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "sh11", type: "interest", path: "shariah", question: { ar: "هل تميل إلى تحليل النصوص الشرعية والأدبية واستخراج الأحكام والمعاني منها؟", en: "Do you tend to analyze religious and literary texts and extract rulings?" }, options: [{ ar: "نعم، أجد متعة في التحليل العميق", en: "Yes, I find deep analysis enjoyable" }, { ar: "أحياناً عندما يكون النص مثيراً", en: "Sometimes when the text is interesting" }, { ar: "أفضل القراءة السطحية السريعة", en: "I prefer quick surface reading" }, { ar: "لا أميل للتحليل النصي", en: "I don't tend toward textual analysis" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "sh12", type: "interest", path: "shariah", question: { ar: "هل تشعر بالشغف عند الدفاع عن حقوق الآخرين وتحقيق العدالة والإنصاف؟", en: "Do you feel passionate about defending rights and achieving justice?" }, options: [{ ar: "نعم، العدالة من أهم قيمي", en: "Yes, justice is one of my core values" }, { ar: "أهتم لكن لا أتدخل دائماً", en: "I care but don't always intervene" }, { ar: "أترك الأمر للمختصين", en: "I leave it to professionals" }, { ar: "لا أشعر بشغف خاص تجاه ذلك", en: "I don't feel particular passion for it" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "sh13", type: "interest", path: "shariah", question: { ar: "هل تفضل دراسة المواد النظرية والفكرية على المواد العلمية التطبيقية؟", en: "Do you prefer theoretical subjects over applied sciences?" }, options: [{ ar: "نعم، النظريات تثير فضولي", en: "Yes, theories spark my curiosity" }, { ar: "أستمتع بالنظري والتطبيقي معاً", en: "I enjoy both theoretical and applied" }, { ar: "أميل للتطبيقي أكثر", en: "I lean more toward applied" }, { ar: "أفضل العمل العملي فقط", en: "I prefer only practical work" }], correctIndex: 0, explanation: { ar: "", en: "" } },
    { id: "sh14", type: "interest", path: "shariah", question: { ar: "هل لديك اهتمام بمتابعة القضايا الحقوقية والمحاكمات والأنظمة القانونية؟", en: "Are you interested in following legal cases, trials and legal systems?" }, options: [{ ar: "نعم، أتابعها باهتمام", en: "Yes, I follow them with interest" }, { ar: "أتابع القضايا الكبيرة فقط", en: "I follow only major cases" }, { ar: "أحياناً من باب الفضول", en: "Sometimes out of curiosity" }, { ar: "لا تهمني القضايا القانونية", en: "Legal cases don't interest me" }], correctIndex: 0, explanation: { ar: "", en: "" } },
